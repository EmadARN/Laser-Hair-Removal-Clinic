...
import { getCutomerList } from "@/features/adminDashboard/adminDashboardSlice";
    ...
    return (
      <>
        ...
        <Box display={"flex"} justifyContent={"center"} px={{ base: 2, md: 4 }}>
          <Table mt={6} cursor="pointer" overflowY="auto" width="100%" size="sm" dir="rtl" variant="">
            <Tbody>
              {!loading && !error && filteredClients && Array.isArray(filteredClients)
