...
const AccordionLists = ({ clientData, mdCancelHandler }) => {
          ...
          <AccordionPanel pb={4}>
            <Stack pt={6}>
              <Box mb={3} display={"flex"} flexDirection={"column"} gap={3}>
                <Text fontSize={{base:'12px',md:"16px"}}>نام و نام خانوادگی</Text>
                <Box
                  fontWeight={"bold"}
              ...
              <Flex width={{base:"100%",md:"50%"}} gap={20} justifyContent={"space-between"}>
                <Stack>
                  <Text fontSize={{base:'12px',md:"16px"}}>سابقه بیماری</Text>
                  <Text textAlign = {"center"} fontSize={{base:'12px',md:"16px"}} py={{base:1,md:2}} bgColor={"#ddd"}>
                    {clientData.decease_hist === true ? "بله" : "خیر"}
                  </Text>
                </Stack>
                <Stack>
                  <Text fontSize={{base:'12px',md:"16px"}}>سابقه مصرف دارو</Text>
                  <Text textAlign={"center"} fontSize={{base:'12px',md:"16px"}} py={{base:1,md:2}} bgColor={"#ddd"}>
  ...
  <Text fontSize={{ base: "lg", md: "xl", lg: "2xl" }}>تاریخچه جلسات</Text>
  <Accordion defaultIndex={[0]} allowMultiple>
    <AccordionItem>
      <Heading as="h2" size="md" noOfLines={1}>
        ...
        >
          <Text mb={4} as="span" textAlign="right" fontSize={{ base: "sm", md: "md" }}>
            1 دوشنبه 17 دی , 1401
          </Text>
          <Stack
          ...
          >
            <Text mb={4}  fontSize={{ base: "sm", md: "md" }}>16:20</Text>
            <Text mb={4} fontSize={{ base: "sm", md: "md" }}>فول بادی</Text>
            <Text  fontSize={{ base: "sm", md: "md" }}>پرداخت نقدی</Text>
          </Stack>
          <AccordionIcon />
        </AccordionButton>
      </Heading>
